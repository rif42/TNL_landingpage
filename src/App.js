  ...
  return (
    <Router>
      ...
      <div className="App">
        ...
        {navState === "Home" ? (
          <div className="w-full h-fit absolute ">
            ...
            <div
              ...
              className="hover:cursor-pointer w-[10vw] h-[3vw] absolute place-self-end z-50 text-[1.5vw] underline text-blue-400 ml-[67.6vw] mt-[42vw]"
            >
              Learn More
            </div>
        ...
        ) : navState === "Home" && learnmore === 1 && slideState === 0 ? (
        ...
        ) : navState === "Home" && learnmore === 1 && slideState === 1 ? (
          <div className="tfs-page w-full h-fit flex flex-col justify-center align-middle">
            ...
            <div className="w-full h-[45vw] flex flex-row justify-center align-middle">
              <div className="w-[50%] h-[45vw] bg-[#f26e9636] flex flex-col justify-center align-middle">
                <p className="text-[#05194A] text-[3vw] text-left px-[12vw] tracking-tighter leading-tight font-extrabold">
                  IF THERE WAS A WAY, JUST IF, WOULD YOU NOT BE CURIOUS TO KNOW
                  MORE?
                </p>
                <p className="font-inter text-[#05194A] text-[1.1vw] text-left px-[12vw] pt-[2vw]">
                  We are talking about the growth of mind, body and soul. For
                  the body, you have your medical and your fitness examinations.
                  <br /> <br />
            ...
            <div className="w-full h-[45vw] flex flex-row justify-center align-middle">
              ...
              <div className="w-[50%] h-[45vw] bg-[#f26e9636] flex flex-col justify-center align-middle">
                ...
                <p className="font-inter text-[#05194A] text-[1.1vw] text-left px-[12vw] pt-[2vw]">
                  Think about it! You can google Social Emotional Learning, or
                  attend courses on udemy or coursera on Self awareness and get
                  all the contents you need. So why The First Step OR The Next
                  Level for that matter you ask?
                </p>
              </div>
            </div>
            ...
            <div className="w-full h-[40vw] flex flex-col justify-center align-middle">
              <div className=" flex flex-col justify-center align-middle bg-tfs3 bg-center bg-contain bg-no-repeat w-[75%] h-full place-self-center">
                ...
                <p className="text-white text-[1.4vw] px-[5vw] pt-[1vw] text-center">
                  ...
                  especially with us, you have an experience that touches your
                  Mind, Body and Soul. It goes deeper!
                </p>
              </div>
            </div>
            ...
            <div className="w-full h-[45vw] flex flex-row flex-wrap justify-center align-middle px-[10vw]">
              <div className="w-[48%] h-[48%] bg-[#D4D5E5] flex flex-col align-middle rounded-3xl m-[0.5vw]">
                ...
                <p className="text-center font-inter text-[1.1vw] text-[#05194A] px-[3vw] pt-[1vw]">
                  ...
                  What’s your purpose? We don’t sit down and discuss this. We
                  have a challenge for this!
                </p>
              </div>
              <div className="w-[48%] h-[48%] bg-[#D4D5E5] flex flex-col align-middle rounded-3xl m-[0.5vw]">
                <img
                ...
                <p className="text-center font-inter text-[1.1vw] text-[#05194A] px-[3vw] pt-[1vw]">
                  ...
                  - 38 characteristics about you that you MUST know. This is
                  like an MRI of your Mind, Body and Soul. Outcomes will stun
                  you.
                </p>
              </div>
              <div className="w-[48%] h-[48%]  bg-[#D4D5E5] flex flex-col align-middle rounded-3xl m-[0.5vw]">
                ...
                <p className="text-center font-inter text-[1.1vw] text-[#05194A] px-[3vw] pt-[1vw]">
                  ...
                  <span className="font-bold">TRUST!</span> We need to believe
                  and honestly, many things will happen for us to lose faith,
                  and that is when you remember what you learned to RENEW your
                  trust. It is never easy but winners find a way.
                </p>
              </div>
              <div className="w-[48%] h-[48%]  bg-[#D4D5E5] flex flex-col align-middle rounded-3xl m-[0.5vw]">
                <img
                ...
                <p className="text-center font-inter text-[1.1vw] text-[#05194A] px-[3vw] pt-[1vw]">
                  ...
                  decision to start the journey of continuously being the best
                  version of you.
                </p>
              </div>
            </div>
            <p className="text-center font-inter text-[1.1vw] text-[#05194A] px-[20vw] pt-[3vw] pb-[5vw]">
              You deserve this! If you only had 4 to 8 hours to learn things
              about yourself that you never knew about or needed confirmation
              on, The First Step is a great start.
            </p>
            ...
            <div className="w-full h-[10vw] bg-[#D3BCE7] flex flex-row justify-evenly align-middle">
              <p className="text-right font-inter font-bold text-[1.1vw] text-[#05194A] w-[35vw] h-[5vw] pt-[3vw] pb-[5vw]">
                For schools and organizations, The First Step is best when done
                in small groups. 25 to 30 for optimum outcomes.
              </p>
        ...
        ) : navState === "Home" && learnmore === 1 && slideState === 2 ? (

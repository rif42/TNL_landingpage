...
function Form() {
    ...
    return (
        <>
            <form action="https://event.getletsflip.com/api/v1/tnl/postform" method="POST" onSubmit={() => handleSubmit()}>
                <div
                    id="registration"
                ...
                >
                    ...
                    <div className="w-[33%] h-[100%] flex flex-col justify-center align-middle ">
                            ...
                            onBlur={() => {
                                if (document.getElementById("country").value.length === 0) {
                                    document.getElementById("country").style.border =
                                        "2px solid red";
                                    document.getElementById("country-error").innerHTML = "Choose valid country!";
                                } else {
                                    document.getElementById("country").style.border =
                                        "2px solid #00FF0A";
                        ...
                        >Hello, I want to connect with the coaches about...</textarea>
                    </div>
